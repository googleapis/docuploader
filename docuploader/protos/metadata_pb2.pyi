...
class Metadata(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"update_time"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"distribution_name",u"github_repository",u"issue_tracker",u"language",u"name",u"product_page",u"update_time",u"version"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"update_time",b"update_time"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[b"distribution_name",b"github_repository",b"issue_tracker",b"language",b"name",b"product_page",b"update_time",b"version"]) -> None: ...
